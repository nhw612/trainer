...
BATCH_SIZE = 64
TRAIN_SZ = 10000  # 훈련 자료 패치의 갯수
VAL_SZ = 3000    # 검증 자료 패치의 갯수, 훈련-검증 비율을 3:1로 잡았으므로 패치의 갯수도 4:1로 계산하는 것이 적절할 듯.

def get_model():
    return unet_model(PATCH_SZ)
